...
import com.tainy.common.base.ResultBean;
import com.tainy.common.base.StatusCode;
...
public class MyAuthenticationFilter extends AuthenticationFilter {
	 ...
	 * @param mappedValue
	 * @return
	 * @see AuthenticationFilter#isAccessAllowed(javax.servlet.ServletRequest, javax.servlet.ServletResponse, Object)
	 */
	@Override
