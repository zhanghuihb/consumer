...
<div class="table-responsive" style="margin-left: 20px;margin-right: 20px;">
    ...
    <div class="table-responsive">
        ...
        <div style="float: left;margin-left: 20px;">
            <input style="width:200px;" type="text" class="form-control" name="queryUsername" placeholder="请输入用户名">
        </div>
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form" method="post">
                            ...
                            <div class="form-group" style="margin-left: auto">
                                ...
                                <div class="col-sm-10">
                                    <select style="width: 90%;height: 500px;" id="addRoleIds" name="addRoleIds" class="form-control" multiple="multiple" data-live-search="false">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form" method="post">
                            ...
                            <div class="form-group" style="margin-left: auto">
                                <label class="col-sm-2 control-label">角色<span style="color: red;">*</span>：</label>
                                <div class="col-sm-10">
                                    <select style="width: 90%;height: 500px;" id="editRoleIds" name="editRoleIds" class="form-control" multiple="multiple">
...
<script src="<%=request.getContextPath() %>/jsp/system/consoleUser.js"></script>
</body>
</html>