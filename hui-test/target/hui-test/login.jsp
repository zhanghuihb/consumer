...
<div class="container">
    <div class="row" style="position: absolute;top: 50%;width: 1170px;margin-top: -189px;">
        <div class="col-xs-6 col-md-offset-3">
            <form class="form-horizontal" role="form" action= javascript:void(0); method="post" onsubmit="return checkUser();">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input style="width:200px;" type="text" class="form-control" id="password" name="password" placeholder="请输入密码">
                    </div>
                </div>
                <div class="form-group">
